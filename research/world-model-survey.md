...
[A Comprehensive Survey on World Models for Embodied AI (revised June 2026 preprint)](https://arxiv.org/abs/2510.16732) compares decision-coupled and general-purpose models, temporal and spatial representations, datasets, and evaluation. It is the best companion here because it asks whether predicted states support action and physical consistency, rather than relying on video appearance alone. It focuses on embodied AI, so the sections below also retain MuZero and scientific dynamics models outside that narrower scope.
